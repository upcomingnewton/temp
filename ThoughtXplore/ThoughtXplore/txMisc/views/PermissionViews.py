...
def  ListPermission(HttpRequest):
    ...
    try:
        ...
        if permlist[0] == 1:
            ...
            return render_to_response('security/perms/EditPermission.html',{'permlist':permlist,'visible_list':'true','visible_create':'false',},context_instance=RequestContext(HttpRequest))
        else:
