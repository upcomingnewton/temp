...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Nath@3728_uiet',                  # Not used with sqlite3.
...
STATIC_ROOT = '/var/www/vhosts/thoughtxplore.com/uiet/ThoughtXplore/ThoughtXplore/static1'
STATIC_URL= '/static/'
...
STATICFILES_DIRS = (
    ...
    '/var/www/vhosts/thoughtxplore.com/uiet/ThoughtXplore/ThoughtXplore/static',
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/var/www/vhosts/thoughtxplore.com/uiet/ThoughtXplore/ThoughtXplore/templates"       
)
INSTALLED_APPS = (
    #'django.contrib.auth',
